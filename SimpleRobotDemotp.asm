...
; Version: 11/5 move towards, stop, turn, and circle
...
Main:
    ...
    LOADI  40          ; period = (10 ms * 10) = 0.1s, or 10Hz.
...
StopAndCircle:
    ...
    STORE   MyVelR
    STORE   MyVelL
    CALL    Wait1       ; wai for the wheels to respond

    LOADI   55         ; turn 55 degress to the left
    ...
    LOADI   32          ;enable sonar number 5
    OUT     SONAREN 
    JUMP    CircleNormal
...
;below is the code for circling, parameters waiting to be tweaked.
CircleNormal:
    LOADI   0
    OUT     TIMER
    LOADI   350
    ...
    OUT     SSEG1
    SUB     SmallRadius
    JNEG    CircleCorrectRight
    IN      DIST5
    SUB     LargeRadius
    JPOS    CircleCorrectLeft
    
    JUMP    CircleNormal

; Correct to the left by making circle with a larger radius
CircleCorrectLeft:
    LOADI   300
    STORE   MyVelL
    LOADI   200
...
; Correct to the right by making a circle with a tighter radius
CircleCorrectRight: 
    LOADI   350
    STORE   MyVelL
    LOADI   250
